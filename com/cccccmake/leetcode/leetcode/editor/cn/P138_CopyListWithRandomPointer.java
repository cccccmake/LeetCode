...
class Solution1 {
    ...
    class Solution {
        public Node copyRandomList(Node head) {
            ...
            Node curNode = head;
            while(curNode != null){
                mapping.put(curNode, new Node(curNode.val));
                curNode = curNode.next;
            }
            curNode = head;
            while(curNode != null){
                Node val = mapping.get(curNode);
                val.next = mapping.get(curNode.next);
                val.random = mapping.get(curNode.random);
                curNode = curNode.next;
            }
